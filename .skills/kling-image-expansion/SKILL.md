...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-dsazr1cm25tt-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
| Query Task (Single) Endpoint | `GET https://app-dsazr1cm25tt-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
| Query Task (List) Endpoint | `GET https://app-dsazr1cm25tt-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
