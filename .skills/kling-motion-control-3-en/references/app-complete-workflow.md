...
const CREATE_ENDPOINT =
  "https://app-dsazr1cm25tt-api-m9xKdopkqvMa.gateway.appmedo.com/motion-control/kling-3.0";
...
const QUERY_ENDPOINT = "https://app-dsazr1cm25tt-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks";
