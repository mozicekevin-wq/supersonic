...
**Endpoint:** `GET https://app-dsazr1cm25tt-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-dsazr1cm25tt-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
