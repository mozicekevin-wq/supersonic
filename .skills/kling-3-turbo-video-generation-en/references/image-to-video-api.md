...
|---|---|
| Region | Singapore |
| Third-party domain | `app-dsazr1cm25tt-api-e94GlB86xpEa.gateway.appmedo.com` |
| Method | `POST` |
...
| API Plugin endpoint | `POST https://app-dsazr1cm25tt-api-e94GlB86xpEa.gateway.appmedo.com/image-to-video/kling-3.0-turbo` |
...
while (true) {
  const queryResponse = await fetch(
    `https://app-dsazr1cm25tt-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks?task_ids=${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
